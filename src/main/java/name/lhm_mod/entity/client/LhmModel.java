...
public class LhmModel<T extends LhmEntity> extends EntityModel<T> {
    ...
    public LhmModel(ModelPart root) {
        ...
        this.head = this.lhm.getChild("head");
    }
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = lhm.addChild("body", ModelPartBuilder.create().uv(243, 0).cuboid(-50.0F, 80.0F, -50.0F, 100.0F, 100.0F, 100.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData head = lhm.addChild("head", ModelPartBuilder.create().uv(83, 202).cuboid(-90.0F, -130.0F, -90.0F, 180.0F, 180.0F, 180.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
